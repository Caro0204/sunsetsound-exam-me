  ...
  return (
    <div>
      <form className={styles} onSubmit={formHandler}>
        <fieldset>
          <legend className={styles.bookingSubtitle}>Billing Information</legend>
          <p className={styles.hint}>Please fill out the information for the desired billing address</p>
          <div className={styles.inputBox}>
            <label htmlFor="fullname">Full name</label>
            <p className={styles.hint}>Write your full name including first, middle, and lastname</p>
            <input className={styles.inputField} name="fullname" id="fullname" type="text" placeholder="Jane Doe" pattern="[A-Za-zæøåÆØÅ]{2,}\s?)+" autoCapitalize="on" autoCorrect="off" title="Please fill out full name" required />
          </div>
          ...
          <div className={styles.inputBox}>
            ...
            <div className={styles.inputBox}>
              ...
              <p className={styles.hint}>Must be 8 characters end exclude country-code</p>
          ...
          <div className={styles.inputBox}>
            ...
            <p className={styles.hint}>Fill out full address including number and/or floor</p>
            <input className={styles.inputField} name="address" id="address" type="text" placeholder="Streetname 1 st.tv" title="Invalid address" autoCapitalize="on" required />
          </div>
          <div className={styles.inputBox}>
            <label htmlFor="zip">Zip</label>

            <input className={`${styles.inputField} ${styles.inputZip}`} name="zip" id="zip" placeholder="2000" title="Invalid zip" pattern="[+0-9]{4,}" required inputmode="numeric" />
          </div>
          <div className={styles.inputBox}>
            <label htmlFor="city">City</label>

            <input className={styles.inputField} name="city" id="city" type="text" title="Invalid city" placeholder="Copenhagen" autoCapitalize="on" autoCorrect="on" required />
          </div>
          {/* <div className={styles.inputBox}>
          ...
          <div className={styles.paymentSection}>
            ...
            <div className={styles.inputBox}>
              ...
              <input className={`${styles.inputField} ${styles.inputCn}`} name="cardnumber" id="cardnumber" placeholder="1122 3344 5566 7788" required maxLength={16} inputmode="numerical" pattern="[0-9]{16}" title="Please fill out cardnumber" />
            </div>
            <div className={styles.smallerField}>
              <div className={styles.inputBox}>
                <label htmlFor="expodate">Exp. Date</label>
                <input className={`${styles.inputField} ${styles.inputExp}`} name="expodate" id="expodate" placeholder="MM/YY" required maxLength={5} inputmode="numerical" onChange={checkForError} pattern="[0-1][0-9][/][0-9]{2}" title="Please fill out exp. date" />
              </div>
              <div className={styles.inputBox}>
                <label htmlFor="cvc">CVC</label>
                <input className={`${styles.inputField} ${styles.inputCvc}`} name="cvc" id="cvc" placeholder="CVC" required maxLength={3} pattern="[0-9]{3}" title="Please fill out CVC" />
              </div>
            </div>
          </div>
