            ...
            <div className={isMobile ? styles.sectionWrapperMobile : isTablet ? styles.sectionWrapperTablet : styles.sectionWrapperDesktop}>
              ...
              {page === 1 && (
                <div>
                  ...
                  <p className={styles.hint}>Fill out the information below for each ticketholder</p>
                ...
                <div className={styles.basketContent}>
                  ...
                  <div>
                    <div className={styles.feeTickets}>
                      {ticketChoice.regular + ticketChoice.vip > 0 && <p className={styles.basketSub2}>Ticket(s):</p>}
                    ...
                    <div className={styles.feeTents}>
                      {gearChoice.twotent + gearChoice.threetent > 0 && <p className={styles.basketSub2}>Tent(s):</p>}
